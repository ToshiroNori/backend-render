													...
													<table class="paragraph_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:10px;padding-top:10px;">
																<div style="color:#848484;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;line-height:180%;text-align:center;mso-line-height-alt:25.2px;">
																	<p style="margin: 0;">Dear [User's Name],</p>
																	...
																	<p style="margin: 0;">This OTP is valid for the next [X] minutes. For your security, please do not share this code with anyone.</p>
																	<p style="margin: 0;">If you did not request this verification, please ignore this email or contact our support team.</p>
																	<p style="margin: 0;">Thank you for choosing DSolution!</p>
																	<p style="margin: 0;">Best regards,<br>The DSolution Team</p>
																</div>
															</td>
														</tr>
													</table>
